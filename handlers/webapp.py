...
async def reply_webapp(message: types.Message):
    ...
    instagram = types.KeyboardButton('Instagram', web_app=types.WebAppInfo(url='https://www.instagram.com/'))


    keyboard.add(geeks_online, youtube, github, netflix , instagram)
